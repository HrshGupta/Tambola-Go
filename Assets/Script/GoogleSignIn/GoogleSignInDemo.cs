...
public class GoogleSignInDemo : MonoBehaviour
{
    ...
    private void SignInWithGoogleOnFirebase(string idToken)
    {
        ...
        auth.SignInWithCredentialAsync(credential).ContinueWith(task =>
        {
            ...
            PlayerPrefs.SetString("UserLoginInfo", "Google");
            ...
            PlayerPrefs.SetString("UserPassword", "aaaaa");
            //PlayerPrefs.SetInt("UserCoin", 500);
            Debug.Log("Google Signin successful");
            //StartCoroutine(Login(task.Result.IdToken , user.DisplayName , user.Email));
